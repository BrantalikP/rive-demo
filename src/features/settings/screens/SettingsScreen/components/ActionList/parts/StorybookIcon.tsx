import { Defs, Mask, Path, Svg, Use } from '~/features/ui/components/Svg'
import { ms } from '~/utils/scale'

export const StorybookIcon = (props: React.ComponentProps<typeof Svg>) => (
  <Svg height={ms(32)} width={ms(32)} fill="none" viewBox="-31.5 0 319 319" {...props}>
    <Defs>
      <Path
        id="a"
